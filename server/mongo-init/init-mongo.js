db = db.getSiblingDB('test'); // Replace 'db_name' with your database name
...
const products = [
  ...
  },
  {
    ...
    description: "Have game experience never before never after fight with every opponent and defeat them.",
    price: 49.99,
...
// Insert the products into the "products" collection
